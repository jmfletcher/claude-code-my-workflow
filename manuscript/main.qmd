...
tbl = (
    wkce_gaps[["year", "subject", "gap_pair", "mean_ss_white", "mean_ss_minority", "gap"]]
    .assign(gap_pair=lambda x: x["gap_pair"].map({"BW": "Black--White", "HW": "Hispanic--White"}))
    .rename(columns={
        "year":             "Year",
        "subject":          "Subject",
...
pub_table(
    ...
    floatfmt=".1f",
    note=(
        r"WKCE scale scores are on a developmental scale; values are not comparable "
        r"across subjects or grades. Gap = White mean minus minority mean scale score. "
        r"B--W = Black--White; H--W = Hispanic--White. "
        r"Values are district-enrollment-weighted state averages across grades 3--8. "
...
```{python}
#| label: tbl-wkce-gr10
#| tbl-cap: "WKCE Grade-10 State-Level Scale-Score Gaps (Reading and Mathematics, 2009--10 to 2012--13)"
#| tbl-pos: H
#| output: asis
...
pub_table(
    ...
    floatfmt=".1f",
    note=(
        r"Grade-10 WKCE scale scores are on a higher part of the developmental scale than "
        r"grades 3--8; absolute gaps are not directly comparable across grade bands. "
        r"Gap = White mean minus minority mean scale score. "
        r"B--W = Black--White; H--W = Hispanic--White. "
