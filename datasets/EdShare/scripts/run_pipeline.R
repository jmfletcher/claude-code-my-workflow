# EdShare authorship concentration pipeline
dataset_name <- "EdShare"
...
run_step("Ingest EdShare publications", python,
         c("scripts/edshare/ingest_publications.py",
           "--output-dir", "datasets/EdShare/raw"))

run_step("Parse EdShare publications", "Rscript",
