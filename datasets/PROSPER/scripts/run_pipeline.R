# PROSPER authorship concentration pipeline (top-x focus)
dataset_name <- "PROSPER"
...
cat("=== PROSPER Pipeline ===\n")

run_step("Fetch PROSPER publications", "Rscript",
         c("scripts/R/fetch_prosper_publications.R", dataset_name))
