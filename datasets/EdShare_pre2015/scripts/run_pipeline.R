# EdShare pre-2015 authorship concentration pipeline
dataset_name <- "EdShare_pre2015"
...
cat("=== EdShare Pre-2015 Pipeline ===\n")

run_step("Parse EdShare publications (<=2014)", "Rscript",
...
cat("\n=== EdShare pre-2015 pipeline complete ===\n")
