# FFCWS authorship concentration pipeline
dataset_name <- "FFCWS"
...
run_step("Parse FFCWS publications", "Rscript",
         c("scripts/R/fetch_ffcws_publications.R", dataset_name))
