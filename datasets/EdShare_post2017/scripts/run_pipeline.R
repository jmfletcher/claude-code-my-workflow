# EdShare post-2017 journal-articles authorship concentration pipeline
dataset_name <- "EdShare_post2017"
...
cat("=== EdShare Post-2017 Pipeline ===\n")

run_step("Parse EdShare publications (2017+ journal articles)", "Rscript",
...
cat("\n=== EdShare post-2017 pipeline complete ===\n")
