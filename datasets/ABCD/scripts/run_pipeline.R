# ABCD authorship concentration pipeline
dataset_name <- "ABCD"
...
run_step("Ingest ABCD publications", ".venv-ffcws/bin/python",
         c("scripts/abcd/ingest_publications.py"))

run_step("Parse ABCD publications", "Rscript",
         c("scripts/R/fetch_abcd_publications.R", dataset_name))
