# WLS authorship concentration pipeline (Zotero source)
dataset_name <- "WLS"
...
run_step("Fetch WLS publications", "Rscript",
         c("scripts/R/fetch_wls_publications.R", dataset_name))
